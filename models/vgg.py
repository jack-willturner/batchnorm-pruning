...
class VGGCompressed():
    def __init__(self, channels):
        ...
        self.conv2 = nn.Conv2d(channels[0], channels[1], 3, stride=1, padding=1)
        self.bn2   = nn.BatchNorm2d(channels[1])
        self.pool1 = nn.MaxPool2d(2, stride=2) # TODO check this

        self.conv3 = nn.Conv2d(channels[1], channels[2], 3, stride=1, padding=1)
        ...
        self.conv6 = nn.Conv2d(channels[4], channels[5], 3)
        ...
        self.conv8 = nn.Conv2d(channels[6], channels[7], 3)
        self.bn8   = nn.BatchNorm2d(channels[7])
        self.pool4 = nn.MaxPool2d(2, stride=2)

        self.conv9  = nn.Conv2d(channels[8], channels[9], 3, stride=1, padding=1)
        self.bn9    = nn.BatchNorm2d(channels[9])
        self.conv10 = nn.Conv2d(channels[9], channels[10], 3)
        self.bn10   = nn.BatchNorm2d(channels[10])
        self.pool5  = nn.MaxPool2d(2, stride=2)

        self.fc1    = nn.Linear(channels[10] * 3 * 3, 1028)
        self.fc2    = nn.Linear(1028, 10)
